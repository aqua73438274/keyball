...
static void process_right_magic(uint16_t keycode, uint8_t mods) { // LMAGIC definitions
    switch (keycode) {
        ...
        case HOM_S: { MAGIC_STRING("v",         KC_NO); } break;
        case HOM_T: { MAGIC_STRING("k",         KC_NO); } break;
        case  KC_U: { MAGIC_STRING("u",         KC_NO); } break;
        case  KC_V: { MAGIC_STRING("x",         KC_NO); } break;
        case NUM_W: { MAGIC_STRING("c",         KC_NO); } break;
...
static void process_left_magic(uint16_t keycode, uint8_t mods) { // RMAGIC definitions
    switch (keycode) {
        ...
        case  KC_P: { MAGIC_STRING("n",         KC_NO); } break;
        ...
        case NUM_W: { MAGIC_STRING("w",         KC_NO); } break;
