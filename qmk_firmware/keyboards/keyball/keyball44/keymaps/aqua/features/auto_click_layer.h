...
const int16_t to_clickable_movement = 7;  // クリックレイヤーが有効になるしきい値
...
enum {
  threshold_mouse_acc_1 = 10,
  threshold_mouse_acc_2 = 15,
  threshold_mouse_acc_3 = 25,
  threshold_mouse_acc_4 = 50,
};

enum {
  coefficiency_mouse_acc_1 = 2,
  coefficiency_mouse_acc_2 = 2,
  coefficiency_mouse_acc_3 = 1,
  coefficiency_mouse_acc_4 = 1,
};
...
int16_t acc_mouse_move(int16_t pos) {
  int16_t ret;
  if(pos < threshold_mouse_acc_1){ 
    ret = pos / coefficiency_mouse_acc_1;
  }else if(pos < threshold_mouse_acc_2){
    ret = pos / coefficiency_mouse_acc_2;
  }else if(pos < threshold_mouse_acc_3){
    ret = pos * coefficiency_mouse_acc_3;
  }else{
    ret = pos * coefficiency_mouse_acc_4;
  }
  return ret;
}
...
report_mouse_t pointing_device_task_user(report_mouse_t mouse_report) {
  ...
  mouse_report.x = acc_mouse_move( current_x );  // 新しいマウスのX座標をマウスレポートにセット
  mouse_report.y = acc_mouse_move( current_y );  // 新しいマウスのY座標をマウスレポートにセット
