...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  ,[NUM] = LAYOUT_universal(
    ...
    ,                   _______, _______, _______, _______, _______, _______
    ,                   KC_TAB , KC_P7   , KC_P8   , KC_P9   , KC_PLUS, KC_SLSH
    ,                   KC_COLN, KC_P1   , KC_P2   , KC_P3   , KC_ENT , KC_ASTR
    ,         _______ , KC_COMM, KC_P4   , KC_P5   , KC_P6   , KC_DOT , _______
    ,         LLOCK   , KC_P0  , XXXXXXX, XXXXXXX, _______, _______, _______
  )
